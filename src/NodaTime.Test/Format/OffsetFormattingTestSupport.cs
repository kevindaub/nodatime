...
namespace NodaTime.Test.Format
{
    ...
    public class OffsetFormattingTestSupport : FormattingTestSupport
    {
        ...
        internal static OffsetData[] OffsetParseData = {
            ...
            new OffsetData(Offset.Zero) { C = EnUs, S = "1", F = "ss", Exception=typeof(UnparsableValueException), Message = Resources.Parse_MismatchedNumber, Parameters = {"ss"} },
            ...
            new OffsetData(Offset.Zero) { C = EnUs, S = "a", F = "%H", Exception=typeof(UnparsableValueException), Message = Resources.Parse_MismatchedNumber, Parameters = {"H"} },
            new OffsetData(Offset.Zero) { C = EnUs, S = "a", F = "%m", Exception=typeof(UnparsableValueException), Message = Resources.Parse_MismatchedNumber, Parameters = {"m"} },
